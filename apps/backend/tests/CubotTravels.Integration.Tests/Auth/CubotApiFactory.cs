...
/// </summary>
public sealed class CubotApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    private readonly PostgreSqlContainer _db = new PostgreSqlBuilder("postgres:16-alpine").Build();

    public const string SigningKey = "cubot-test-signing-key-must-be-long-enough-256bit-aaaa";
    public const string Password = "Secret123!";
    public const string SingleEmail = "single@cubot.travels";
    public const string MultiEmail = "multi@cubot.travels";
    public const string SuperEmail = "super@cubot.travels";
    ...
    public async Task InitializeAsync()
    {
        ...
        var ctx = scope.ServiceProvider.GetRequiredService<CubotTravelsDbContext>();
