...
namespace CubotTravels.Integration.Tests;
...
public sealed class TenantIsolationTests : IAsyncLifetime
{
    ...
    private CubotTravelsDbContext CreateContext(Guid? tenantId)
    {
        ...
        return new CubotTravelsDbContext(options, tenantContext);
    }
